...
export const NexaLogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="nexa-grad" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="#22d3ee" />
        <stop offset="100%" stopColor="#a855f7" />
      </linearGradient>
    </defs>
    <path
      d="M25 20 V 80 L 75 20 V 80"
      stroke="url(#nexa-grad)"
      strokeWidth="8"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <circle cx="25" cy="20" r="6" fill="url(#nexa-grad)" />
    <circle cx="25" cy="80" r="6" fill="url(#nexa-grad)" />
    <circle cx="75" cy="20" r="6" fill="url(#nexa-grad)" />
    <circle cx="75" cy="80" r="6" fill="url(#nexa-grad)" />
    <circle cx="25" cy="50" r="4" fill="url(#nexa-grad)" />
  </svg>
);
...
export const AttachmentIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3.375 3.375 0 1112.81 7.34l-8.473 8.473a1.875 1.875 0 002.65 2.65L18.375 12.74z" />
    </svg>
);
...
export const SendWaveIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
